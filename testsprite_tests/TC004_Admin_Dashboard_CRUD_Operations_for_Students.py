...
async def run_test():
    ...
    try:
        ...
        # Log in as admin using data-testid selectors
        ...
        await page.goto('http://localhost:3000/ar/admin/students', wait_until="commit", timeout=30000)
        try:
            await page.wait_for_load_state("domcontentloaded", timeout=5000)
        except async_api.Error:
            pass
        ...
        # Assert students page loaded with key elements
        frame = context.pages[-1]
