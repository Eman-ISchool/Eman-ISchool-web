...
async def run_test():
    ...
    try:
        ...
        # Try to access admin dashboard as student (RBAC enforcement test)
        await page.goto('http://localhost:3000/ar/admin/home', wait_until="commit", timeout=30000)
        try:
        ...
        # Assert: student should be redirected away from admin dashboard
        current_url = page.url
        assert '/admin/home' not in current_url, (
            f"RBAC FAIL: Student was able to access admin dashboard. Current URL: {current_url}"
        )
        await asyncio.sleep(2)
