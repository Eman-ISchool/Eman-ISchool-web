...
async def run_test():
    ...
    try:
        ...
        # Assert assessments page loaded (URL confirms navigation)
        current_url = page.url
        assert '/assessments' in current_url or '/student' in current_url, (
            f"Student was not able to access assessments page. Current URL: {current_url}"
        )
        await asyncio.sleep(2)
