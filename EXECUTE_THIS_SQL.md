# Quick Start: Execute This SQL in Supabase

**Instructions:**
1. Copy ALL the SQL below (scroll to see everything)
2. Open Supabase Dashboard: https://cxphxyblhvrupnmcmtoy.supabase.co
3. Go to SQL Editor → New Query
4. Paste and click "Run"
5. After success, go to http://localhost:3000/student/reels and click "Create Sample Reels"
