        ...
        <div className={`space-y-8 ${isArabic ? 'rtl' : 'ltr'}`}>
            ...
            <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => handleNavigation('/temp-teacher/profile')}
                        className="p-2 rounded-lg bg-gray-50 text-gray-500 hover:bg-gray-100 transition-colors"
                    >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <StatCard
                    ...
                    color="blue"
                    onClick={() => handleNavigation('/temp-teacher/courses')}
                />
                <StatCard
                    ...
                    color="emerald"
                    onClick={() => handleNavigation('/temp-teacher/subjects')}
                />
                <StatCard
                ...
                <StatCard
                    ...
                    color="rose"
                    onClick={() => handleNavigation('/temp-teacher/assessments')}
                />
            </div>
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                        onClick={() => handleNavigation('/temp-teacher/calendar')}
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12 border border-dashed border-gray-200 rounded-2xl">
                        ...
                        <button
                            onClick={() => handleNavigation('/temp-teacher/lessons/new')}
            ...
            <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <QuickAction
                        ...
                        onClick={() => handleNavigation('/temp-teacher/courses/create')}
                    />
                    <QuickAction
                        icon={<Layers className="h-5 w-5" />}
                        label={isArabic ? 'مادة جديدة' : 'New Subject'}
                        onClick={() => handleNavigation('/temp-teacher/subjects/create')}
                    />
                    <QuickAction
