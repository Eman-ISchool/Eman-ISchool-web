...
export default async function SubjectMaterialsPage({
    ...
    if (!subject) {
        redirect(withLocalePrefix('/temp-teacher/subjects', locale));
    }
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button asChild className="gap-2 bg-brand-primary text-black hover:bg-yellow-400">
                    <Link href={withLocalePrefix(`/temp-teacher/subjects/${subjectId}/materials/new`, locale)}>
                        ...
                        <Card key={material.id} className="flex flex-col">
                            ...
                            <CardFooter className="border-t pt-4">
                                <Button asChild variant="outline" className="w-full gap-2">
                                    <Link href={withLocalePrefix(`/temp-teacher/subjects/${subjectId}/materials/${material.id}/lessons`, locale)}>
