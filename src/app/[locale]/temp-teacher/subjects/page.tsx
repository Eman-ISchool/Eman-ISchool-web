    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Link
                    href={withLocalePrefix('/temp-teacher/subjects/new', locale)}
            ...
            {subjects.length === 0 ? (
                <EmptyState
                    ...
                    action={{ label: isArabic ? 'مادة جديدة' : 'New Subject', href: withLocalePrefix('/temp-teacher/subjects/new', locale) }}
                />
            ) : (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {subjects.map((subject: any) => (
                        <Link
                            key={subject.id}
                            href={withLocalePrefix(`/temp-teacher/subjects/${subject.id}`, locale)}
